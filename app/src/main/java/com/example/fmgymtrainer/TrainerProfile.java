...
public class TrainerProfile extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds : snapshot.getChildren()){
                    ...
                    Glide.with(TrainerProfile.this).load(profile).into(profilepic);
                }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(TrainerProfile.this, "An error occurred!", Toast.LENGTH_LONG).show();
            }
        });
        ...
        profilepic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                Intent intent = new Intent(TrainerProfile.this, ViewProfile.class);
    ...
    private void bottomAlertDialog() {
        ...
        BottomSheetDialog sheetDialog = new BottomSheetDialog(TrainerProfile.this, R.style.BottomSheetStyle);
        ...
        sheetView.findViewById(R.id.editProfile).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sheetDialog.dismiss();
                Intent intent = new Intent(TrainerProfile.this, TrainerEditProfile.class);
                startActivity(intent);
            }
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.navigation_home:
                Intent intent4 = new Intent(TrainerProfile.this, TrainerDashboard.class);
                startActivity(intent4);
                break;

            case R.id.navigation_profile:
                Intent intent = new Intent(TrainerProfile.this, TrainerProfile.class);
                startActivity(intent);
                break;

            case R.id.navigation_search:
                Intent intent1 = new Intent(TrainerProfile.this, UserList.class);
                startActivity(intent1);
                break;

            case R.id.navigation_logout:
                Toast.makeText(TrainerProfile.this, "Logout Successfully!", Toast.LENGTH_LONG).show();
                logAuth.signOut();
                Intent intent2 = new Intent(TrainerProfile.this, Login.class);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds : snapshot.getChildren()){
                    ...
                    Glide.with(TrainerProfile.this).load(profile).into(navProfile);
